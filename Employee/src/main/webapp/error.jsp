...
<h1><strong>Oops! Something Wents Wrong.....</strong></h1><br>
<a href="listdlt.jsp" class="btn btn-primary">Goto List</a><br><br><br>

<a href="index.jsp" class="btn btn-primary">Back To Home</a><br><br><br>
</div>
<div id="bg-wrap">
