...
<h1><strong>Successfully Executed</strong></h1><br>
<a href="listbtn.jsp" class="btn btn-primary">Goto List</a><br><br><br>

<a href="home.jsp" class="btn btn-primary">Back To Home</a><br><br><br>
</div>
<div id="bg-wrap">
