...
<form action="insert">
 ID:<input type="text" name="id" placeholder="Enter ID" ><br><br><br>
 ...
 Age:<input type="number" name="age" placeholder="Enter Age" pattern="/^-?\d+\.?\d*$/" onKeyPress="if(this.value.length==3) return false;" /><br><br><br>
 Salary:<input type="text" name="salary" placeholder="Enter Salary" ><br><br><br>
