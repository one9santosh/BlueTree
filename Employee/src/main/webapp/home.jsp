...
<div class="content">
<h1><strong>Employee Management</strong></h1><br>
<a href="index.jsp" class="btn btn-primary">Add Employee</a><br><br><br>
<a href="listbtn.jsp" class="btn btn-primary">View Employee</a><br><br><br>
